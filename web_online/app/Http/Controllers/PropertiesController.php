...
class PropertiesController extends Controller
{
    public function index(){
        ...
        return view ("properties.properties",['thuoctinh' => $vc]);
    }
    public function properties_add(){
        $loaisp = new Thuoctinh(); 
        $thuoctinh = DB::SELECT('select * from thuoctinh' );
        return view ("properties.properties_add",['loai' => $loaisp, 'thuoctinh' => $thuoctinh]);
    }
    ...
    public function properties_edit(Request $req){
        ...
        $thuoctinh = DB::SELECT('select *from thuoctinh');
        return view ("properties/properties_edit",['thuoctinh' => $thuoctinh, 'loai' => $loai[0]]);
