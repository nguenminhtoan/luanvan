...
Route::group(['prefix' => 'admin', "middleware"=> ["login", "roleAdmin"]], function () {
    ...
    Route::get('/management/dashboard',"AdminController@dashboard");
    Route::get('/cuahang/list',"AdminController@index");
    Route::get('/cuahang/detail/{id}',"AdminController@detail");
    Route::post('/cuahang/update_status/{id}',"AdminController@update_ch");
