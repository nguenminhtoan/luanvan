            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="addvoucher">
                        <div class="row">
                            <div class="col-lg-8">
                                <h3 class="mt-2">Thêm một Thuộc tính mới</h3>
                                <p class="text-muted mb-4"></p>
                                <form role="form" action="/admin/properties/save" method="post" enctype="multipart/form-data">
                                    {{ csrf_field()}}
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="text" name="TEN_THUOCTINH" placeholder="Tên thuộc tính" id="ten_thuoctinh" value={{$loai -> TEN_THUOCTINH}}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-4">
