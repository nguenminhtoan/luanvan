                    ...
                    <div class="tab-pane show active" id="addindustries">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form role="form" action="/admin/status/update/{{$loai->MA_TRANGTHAI}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Mã trạng thái</label>
                                                <input class="form-control" type="text" name="MA_TRANGTHAI" placeholder="Mã trạng thái" id="ma_nganh" value={{$loai -> MA_TRANGTHAI}} >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
