                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="text-sm-end">
                            <form action="/admin/ship/padding" method="get">
                                <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-action">
                                    <a href="javascript:void(0)" onclick="tiepnhan(this,{{$sp -> MA_DONBAN}});" class="btn btn-primary">Tiếp nhận</a>
                                </td>
                            </tr>
                            @endforeach
                            @endif
...
<!-- container -->
<script>
    function tiepnhan(evnt,id){
        $.ajax({
            method: "get",
            url: "/admin/ship/tiepnhan?MA_DONBAN="+id,
