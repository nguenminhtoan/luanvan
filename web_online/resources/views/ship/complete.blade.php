                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="text-sm-end">
                            <form action="/admin/ship/complete" method="get">
                                <div class="row">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-action">
                                    <button {{ $sp->NGAYGIAO == date("Y-m-d") ? "" : 'disabled' }} onclick="trahang(this,{{$sp -> MA_DONBAN}});" class="btn btn-primary">Trả hàng</button>
                                </td>
                            </tr>
                            @endforeach
                            @endif
...
<!-- container -->
<script>
    function trahang(evnt,id){
        $.ajax({
            method: "get",
            url: "/admin/ship/trahang?MA_DONBAN="+id,
