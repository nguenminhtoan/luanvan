        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="addcategories">
                        <div class="row">
                            <div class="col-lg-8">
                                <h3 class="mt-2">Chỉnh sửa danh mục</h3>
                                <p class="text-muted mb-4"></p>
                                <form role="form" action="/admin/categories/update/{{$loai->MA_DANHMUC}}" method="post" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="DAN_MA_DANHMUC">
                                                    ...
                                                    @foreach ($danhmuc as $dmsp)
                                                        ...
                                                        <option value="{{ $dmsp->MA_DANHMUC }}" {{ $dmsp->MA_DANHMUC == $loai->DAN_MA_DANHMUC ? 'selected' : '' }}>{{ $dmsp->TEN_DANHMUC }}</option>
                                                        @endif
                                                    @endforeach
                                                    @endif
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <label class="control-label col-lg-4" name='input_img' for="danhmuc_image">Hình ảnh</label>
                                            <div class="col-lg-8">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-preview thumbnail"  style="width: 200px; height: 150px;">
                                                        <img id="hinhanh" style="width: 200px; height: 150px;" src='{{$loai->HINHANH}}'>
                                                    </div>
