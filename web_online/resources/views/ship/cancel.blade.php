                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="text-sm-end">
                            <form action="/admin/ship/cancel" method="get">
                                <div class="row">
                    ...
                    <table class="table table-centered w-100 dt-responsive nowrap" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $sp->MA_TRANGTHAI == 8 ? "Trả hàng" : "Đã hủy" }}
                                </td>
                                <td>
                                ...
                                <td class="table-action">
                                    <button onclick="hoanlai(this,{{$sp -> MA_DONBAN}});" class="btn btn-primary">Hoàn shop</button>
                                </td>
                            </tr>
                            @endforeach
                            @endif
...
<!-- container -->
<script>
    function hoanlai(evnt,id){
        $.ajax({
            method: "get",
            url: "/admin/ship/hoanlai?MA_DONBAN="+id,
